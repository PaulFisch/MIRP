...
macro(mirp_find_library libname)
    ...
    set_target_properties(mirp_imported_${libname} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES /usr/include)
    set_target_properties(mirp_imported_${libname} PROPERTIES INTERFACE_SYSTEM_INCLUDE_DIRECTORIES /usr/include)
    list(APPEND MIRP_DEPS_TARGETS "mirp_imported_${libname}")

endmacro()

mirp_find_library(flint-arb)
